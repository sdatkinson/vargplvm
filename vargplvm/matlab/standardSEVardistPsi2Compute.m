function [K, outKern, sumKern, Kgvar] = standardSEVardistPsi2Compute(sKern, vardist, Z)
...
if pool_open && (isfield(vardist,'parallel') && vardist.parallel) && size(vardist.means,1) > 15
    [K, outKern, sumKern, Kgvar] = rbfard2VardistPsi2ComputePar(sKern, vardist, Z);
else
    [K, outKern, sumKern, Kgvar] = rbfard2VardistPsi2ComputeOrig(sKern, vardist, Z);
end

end


function [K, outKern, sumKern, Kgvar] = rbfard2VardistPsi2ComputePar(~, vardist, Z)
...
function [K, outKern, sumKern, Kgvar] = rbfard2VardistPsi2ComputeOrig(~, vardist, Z)
