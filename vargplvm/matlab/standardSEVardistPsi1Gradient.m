function [gKern, gVarmeans, gVarcovars, gInd] = ...
    standardSEVardistPsi1Gradient(sKern, vardist, Z, covGrad, ...
    learnInducing)
...
[K_fu, Knovar] = rbfard2VardistPsi1Compute(sKern, vardist, Z);
...
% compute the gradient wrt lengthscales (1 per dimension), 
% variational means (n per dimension), 
% and variational variances (n per dimension)
